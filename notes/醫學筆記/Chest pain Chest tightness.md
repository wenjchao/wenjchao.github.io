...
## 內文
- 注意：Mild Dyspnea 會以 Chest tightness 表現，不能漏掉

- 注意：不要太執著某個特定finding。GERD含NTG也可以變好，MI也可能含了沒效
...
- 注意：ACS in ACLS: MONA but

  Morphine 效果 controversial

  NTG 不可以用在 hypotension & Right heart infarction

  Aspirin 要不做 cath 的病人才能用
